...
public class ContentAdapter extends ListAdapter<ContentItem, ContentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ContentItem item = getItem(position);
        if (item != null) {
            holder.bind(item, clickListener, selectionListener);
        }
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final ContentItem item, final OnContentClickListener clickListener, final OnItemSelectionListener selectionListener) {
