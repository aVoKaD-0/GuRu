            ...
            if (newsViewModel != null) {
                ...
                try {
                    newsViewModel.loadLatestNews(7);
                            Timber.d("Запрос последних новостей выполнен после задержки (корутина)");
                } catch (Exception e) {
                            if (e instanceof CancellationException) {
                                Timber.i("Новостная корутина отменена");
                                throw e;
                            }
                            Timber.e(e, "Ошибка при загрузке новостей после задержки (корутина)");
                        }
