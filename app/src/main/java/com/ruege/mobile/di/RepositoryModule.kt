...
object RepositoryModule {
    ...
    fun provideTheoryRepository(
        ...
        userDao: UserDao
    ): com.ruege.mobile.data.repository.TheoryRepository {
        return com.ruege.mobile.data.repository.TheoryRepository(contentDao, theoryApiService, downloadedTheoryDao, externalScope, userDao)
    }
    ...
    fun provideTasksRepository(
        ...
        externalScope: CoroutineScope,
        userDao: UserDao
    ): com.ruege.mobile.data.repository.TasksRepository {
        return com.ruege.mobile.data.repository.TasksRepository(taskDao, contentDao, taskApiService, taskTextDao, externalScope, userDao)
    }
    ...
    fun provideEssayRepository(
        ...
        externalScope: CoroutineScope,
        userDao: UserDao
    ): com.ruege.mobile.data.repository.EssayRepository {
        return com.ruege.mobile.data.repository.EssayRepository(contentDao, essayApiService, externalScope, userDao)
    }
