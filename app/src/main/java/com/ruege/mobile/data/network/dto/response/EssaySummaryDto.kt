...
data class EssaySummaryDto(
    ...
    fun toContentEntity(): ContentEntity {
        try {
            ...
            Timber.d("EssaySummaryDto", "Converting to ContentEntity: id=$id, ege=$egeNumber, " +
            ...
            Timber.d("EssaySummaryDto", "Created ContentEntity - contentId: ${entity.contentId}, " +
                  "title: ${entity.title}, type: ${entity.type}")

            return entity
        } catch (e: Exception) {
            Timber.e("EssaySummaryDto", "Error creating ContentEntity", e)
